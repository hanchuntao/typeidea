# Generated by Django 2.2.3 on 2019-07-22 14:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_type', models.PositiveIntegerField(choices=[(1, 'HTML'), (2, '最新文章'), (3, '最热文章'), (4, '最近评论')], default=1, verbose_name='展未类型')),
                ('content', models.TextField(blank=True, help_text='如果设置的不TML是类，可为空', max_length=500, verbose_name='内容')),
